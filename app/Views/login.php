                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <img src="assets/image/campus.jpg" alt="" srcset="" style="height: 600px;">
                            </div>
                            <div class="col-lg-6" style="background-color: white; border-top-left-radius: 25px; border-bottom-left-radius: 25px;">
                                <div class="p-5">
